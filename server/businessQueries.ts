...
// Qidiruvni normallashtirish `shared/`da turadi — brauzerdagi interfeys ham
// aynan shu funksiyalarni ishlatadi, shunda natijalar ikki joyda bir xil bo'ladi.
export { normalizeSearch, normalizeSearchable } from "../shared/translit";
