...
Bu `drizzle/` papkasidagi barcha SQL migratsiyalarni (`0000`–`0006`)
...
`bottle_movements` (butilka harakati) jadvalini o'z ichiga oladi; `0005` unga
"sotib olindi" turini qo'shadi, `0006` esa savdo foydasini hisoblash uchun
`stockMovements.unitCost` va `transactions.unitCost` ustunlarini qo'shadi.
