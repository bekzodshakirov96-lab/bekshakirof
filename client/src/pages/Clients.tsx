        ...
        <DialogFooter>
          ...
          <Button
            ...
            onClick={() => editClient && update.mutate({
              ...
              clientType: editClient.clientType ? (editClient.clientType as "keg" | "savdo" | "both") : null,
