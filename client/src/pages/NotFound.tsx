...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[radial-gradient(circle_at_top_left,rgba(8,145,178,0.12),transparent_34%),linear-gradient(135deg,#f8fafc,#eef2ff)] px-4">
      <Card className="w-full max-w-lg overflow-hidden rounded-[28px] border-0 bg-card/90 shadow-[0_28px_80px_-36px_rgba(15,23,42,0.45)] backdrop-blur-xl">
        <CardContent className="px-7 py-10 text-center sm:px-12 sm:py-12">
          ...
          <h1 className="mb-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Sahifa topilmadi</h1>
