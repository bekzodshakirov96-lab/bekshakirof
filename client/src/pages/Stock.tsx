...
import { AlertTriangle, Boxes, Factory, Package, PackageCheck, RotateCcw, Search, Send, ShoppingCart, Trash2 } from "lucide-react";
...
function FactoryLedger() {
  ...
  return (
    <>
      <SectionCard title="Zavod bilan hisob-kitob" description="Bo'sh tara yuborish, to'la keg qabul qilish va brak almashinuvini kuzating." className="mt-5">
        {balances.isLoading ? (
