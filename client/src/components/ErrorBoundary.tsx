    ...
    if (this.state.hasError) {
      return (
        <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.12),transparent_32%),linear-gradient(135deg,#f8fafc,#fff7ed)] p-6">
          <div className="flex w-full max-w-xl flex-col items-center rounded-[28px] bg-card/90 p-8 text-center shadow-[0_28px_80px_-36px_rgba(15,23,42,0.45)] backdrop-blur-xl sm:p-12">
            ...
            <h2 className="mb-4 text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Kutilmagan xatolik yuz berdi</h2>
            <p className="mb-8 max-w-md leading-7 text-muted-foreground">
